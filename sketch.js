function setup() {
  ...
  background(51, 0, 0);//background color
  ...
  translate(80, 80);//specifies an amount to displace objects within the display window
  ...
  rect(40, 60, 120, 120);//draws the rectangle with given parameters-medium (x,y,w,h)
  ...
  push();//used in pairing with pop(); to enclose functions
  translate(360, 80);//translates the object to a different location within the given canvas
